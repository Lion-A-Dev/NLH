...
```
cd existing_repo
git remote add origin https://gitlab.com/lion_jean/northenlighthospital_la_jc.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lion_jean/northenlighthospital_la_jc/-/settings/integrations)
